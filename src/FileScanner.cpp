...
void FileScanner::reopenStreamOnCreateEvent() {
...
void FileScanner::scan() {
	reopenStreamTask_ = this->reopenStreamTask();
...
std::thread FileScanner::reopenStreamTask() {
	std::cerr << "spawning reopening thread" << std::endl;
	return std::thread(&FileScanner::reopenStreamOnCreateEvent, this);
}
